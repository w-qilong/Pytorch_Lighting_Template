...
class ExampleTestdata(Dataset):
    def __init__(self):
        ...
        self.test_data, self.test_labels = load_data(self.folder, self.data_file, self.label_file)
...
if __name__ == '__main__':
    ...
    minist_test_dataset = ExampleTestdata()
    print(len(minist_test_dataset))

    dataloader = DataLoader(dataset=minist_test_dataset, batch_size=2, shuffle=False, num_workers=4)
